...
class AJAlertController: UIViewController {
    ...
    private var strAlertTitle = "HOFFER"
    private var strAlertText = String()
    private var btnCancelTitle:String?
    private var btnOtherTitle:String?
    
    private let btnOtherColor  = Global.kAppColor.ButtonColor
    private let btnCancelColor = Global.kAppColor.PrimaryTheme
    ...
    private func setupAJAlertController(){
        ...
        lblTitle.textColor = Global.kAppColor.PrimaryTheme
    ...
    public func showRedAlertWithOkButton( aStrMessage:String,
                                       completion : alertCompletionBlock){
        configure(message: aStrMessage, btnCancelTitle: nil, btnOtherTitle: nil)
        show()
        block = completion
        lblAlertText?.textColor = UIColor.red
        lblTitle?.textColor = UIColor.red
        lblAlertText?.textAlignment = .left
    }
 }
